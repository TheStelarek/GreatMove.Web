...
import styles from '@/components/exercises/addExerciseModal/AddExerciseModal.module.scss';
import { useAddExerciseMutation, useUpdateExerciseMutation } from '@/store/api/exercisesApi';
...
interface AddExerciseModalProps {
   ...
   setSelectedExercise: Dispatch<SetStateAction<ExerciseType | undefined>>;
}
